...
![REST APIs](https://img.shields.io/badge/REST%20APIs-4A5568?style=flat-square&logo=fastapi&logoColor=white)
![JPA/Hibernate](https://img.shields.io/badge/JPA%2FHibernate-ED8936?style=flat-square&logo=java&logoColor=white)
...
**O que aprendi:** Arquitetura real (controllers, services, repositories, DTOs), autenticação JWT, integração com API de pagamento, relacionamentos complexos no banco.

→ Backend: [Ver](https://github.com/GusAraujodev/Projeto-Integrador-Gilede-Vieira--BackEnd)  
→ Frontend: [Ver](https://github.com/GusAraujodev/Projeto-Integrador-Gilede-Vieira--FrontEnd)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/gustavo-araujo-dev/)
